...
public class DataDriven {
    ...
    public static ArrayList<String> getTestData(String nombreCP) {
        ...
        try {
            file = new FileInputStream(System.getProperty("user.dir")+"/src/test/resources/data/DataSet.xlsx");
        ...
        for(int i =0; i< sheets;i++){
            if(excel.getSheetName(i).equalsIgnoreCase("DatosDePrueba")){
                ...
                while(celdas.hasNext()){
                    ...
                    if(celdaSelecciona.getStringCellValue().equalsIgnoreCase("CasoDePrueba")){
